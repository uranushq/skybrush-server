...
# Keep the planned figure aligned with the explicit policy minimum even if
# floating-point drift nudges the derived value.
if abs(PLANNED_XY_CLEARANCE - MIN_FORMATION_XY_CLEARANCE) > 1e-9:
